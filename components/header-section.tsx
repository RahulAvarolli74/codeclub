                    ...
                    <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-32 lg:pt-48">
                        <div className="relative z-10 mx-auto max-w-4xl text-center">
                            <TextEffect
                                ...
                                speedSegment={0.3}
                                as="h1"
                                className={cn("text-balance text-5xl font-medium md:text-6xl",fontHeading.className)}>
                            ...
                            <TextEffect
                                ...
                                A community for students dedicated to the craft of problem-solving.
                            </TextEffect>
                            <AnimatedGroup
                                variants={{
                                    container: {
    ...
    return (
        <div className="relative space-y-3 rounded-[1rem] bg-white/5 p-4">
            ...
            <div className="space-y-3">
                <div className="text-foreground border-b border-white/10 pb-3 text-sm font-medium">Track your growth. 🚀</div>
                <div className="space-y-3">
